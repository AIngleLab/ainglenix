{ pkgs }:
let
  # ie: ai-happ-scaffold <path-to-package-file> <path-to-new-happ-dir>
  name = "ai-happ-scaffold";
  ...
  ''
    ...
    curl -L -o happ-scaffold.tar.gz https://github.com/AIngleLab/RAD-Tools-Phase-2/archive/master.tar.gz
    mkdir "''${2:-"My-New-App"}"
